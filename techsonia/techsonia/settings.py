...
TEMPLATES_DIR = os.path.join(BASE_DIR, 'soniablog/templates')
...
WSGI_APPLICATION = 'techsonia.wsgi.application'
...
MEDIA_URL ='/images/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'techsonia/static')
]
